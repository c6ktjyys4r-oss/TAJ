...
export const UpdateBanner: React.FC = () => {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed bottom-24 md:bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 px-4 py-3 bg-ink-primary text-white rounded-xl shadow-float text-sm font-medium w-[calc(100%-2rem)] max-w-sm no-print"
    >

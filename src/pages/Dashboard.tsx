...
const LAUNCHPAD = [
  ...
  { icon: <FolderOpen size={22} />, title: 'Unclassified', description: 'Review documents awaiting classification',         to: '/documents?tab=unclassified', badge: 7,  accentColor: 'from-orange-50 to-amber-50' },
...
const STATS = [
  { label: 'Documents', value: 4821, suffix: '',   prefix: '', decimals: 0 },
